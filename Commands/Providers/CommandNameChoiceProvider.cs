...
public class CommandNameChoiceProvider : ChoiceProvider
{
    ...
    private IEnumerable<DiscordApplicationCommandOptionChoice> GetCommands()
    {
        var l = new List<DiscordApplicationCommandOptionChoice> {
            new DiscordApplicationCommandOptionChoice(CMD_CONSTANT.ADD_FORM_COMMAND_NAME, CMD_CONSTANT.ADD_FORM_COMMAND_NAME),
            new DiscordApplicationCommandOptionChoice(CMD_CONSTANT.EMBED_COMMAND_NAME, CMD_CONSTANT.EMBED_COMMAND_NAME),
            new DiscordApplicationCommandOptionChoice(CMD_CONSTANT.GET_ALL_FORM_COMMAND_NAME, CMD_CONSTANT.GET_ALL_FORM_COMMAND_NAME),
            new DiscordApplicationCommandOptionChoice(CMD_CONSTANT.GET_BUTTON_COMMAND_NAME, CMD_CONSTANT.GET_BUTTON_COMMAND_NAME),
